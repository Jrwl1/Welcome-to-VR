...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public class TurnProvider : ContinuousTurnProviderBase
    {
        [SerializeField]
        ...
        private InputActionProperty m_LeftHandTurnAction = new InputActionProperty(new InputAction("Left Hand Turn", expectedControlType: "Vector2"));
        /// <summary>
        ...
        private InputActionProperty m_RightHandTurnAction = new InputActionProperty(new InputAction("Right Hand Turn", expectedControlType: "Vector2"));
        /// <summary>
        ...
        [SerializeField]
        private float smoothingFactor = 5.0f; // Adjust this value as needed
        ...
        protected override Vector2 ReadInput()
        {
            ...
            currentInput = leftHandValue + rightHandValue;
            smoothedInput = Vector2.Lerp(smoothedInput, currentInput, Time.deltaTime * smoothingFactor);
